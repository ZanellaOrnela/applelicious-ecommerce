        ...
        <div className="py-14 grid grid-cols-12 gap-x-5 gap-y-8">
          <div className="col-span-full xl:col-span-3 relative bg-custom-pink rounded-3xl gap-6 p-6 xl:w-72 h-50 flex flex-col justify-center items-center">
            ...
            <p className="text-center text-gray-200">
              Con la confianza de miles de clientes en Argentina. ¿Tienes alguna
              consulta? Contáctanos, estamos aquí para ayudarte.
            </p>

            <div className="flex  space-x-4 sm:justify-center  ">
              <a className="w-9 h-9 rounded-full bg-white flex justify-center items-center hover:shadow-md">
                <svg
              ...
              <a className="w-9 h-9 rounded-full bg-white flex justify-center items-center hover:shadow-md">
                <svg
                  className="w-[1.25rem] h-[0.875rem]"
                  viewBox="0 0 16 12"
                  fill="none"
                  xmlns="http://www.w3.org/2000/svg"
                >
          ...
          <div className="block text-center xl:text-left xl:py-16 col-span-full min-[500px]:col-span-6 md:col-span-4 xl:col-span-3 xl:pl-5">
            ...
            <ul className="text-gray-900 transition-all duration-500 grid gap-6">
              <li>soporte@applelicious.com.ar</li>
